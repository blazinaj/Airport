...
namespace Airport
{
    public class SystemManager
    {
        ...
        public string CreatePort(string type, string name)
        {
            try
            {
                (Port port, string success) = factory.CreatePort(type, name, information.GetPortList(type));

                information.AddPortInformation(type, port);
        ...
        public string CreateLine(string type, string name)
        {
            try
            {
                (Line line, string success) = Factory.CreateLine(type, name);

                information.AddLineInformation(type, line);
